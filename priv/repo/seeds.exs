...
Repo.insert!(%User{name: "worker4", email: "worker4@example.com", password_hash:  Argon2.add_hash("passwordworker4").password_hash, supervisor_id: 2})
Repo.insert!(%User{name: "worker5", email: "worker5@example.com", password_hash:  Argon2.add_hash("passwordworker5").password_hash, supervisor_id: 2})
Repo.insert!(%User{name: "worker6", email: "worker6@example.com", password_hash:  Argon2.add_hash("passwordworker6").password_hash, supervisor_id: 3})
